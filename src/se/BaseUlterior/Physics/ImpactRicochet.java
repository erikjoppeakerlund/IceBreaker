...
// protected int farmesTillGone = 0;
//
...
// angled.sub(N);
//
// GameObjectSplit random = new GameObjectSplit(other.getCenterX(),
// other.getCenterY(), angled);
// BreakingPoint.objsToAdd.add(random);
// if (farmesTillGone > 40) {
// origin.removeImpact(this);
// }
// }
//
// }
